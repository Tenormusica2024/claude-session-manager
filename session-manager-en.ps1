...
function Get-QuickTitle {
    ...
    function Test-MeaningfulTitle {
        ...
        $skipPatterns = @(
            ...
            "^(Perfect|Great|Excellent|Awesome|Nice|Good|Right|Understood|Check|Report|test$)",
            # Greetings/conversational
            "^(Hi|Hello|Hey|Yo|So|Well|Now|Alright|Let me|I'll|I will|I'm going to)",
            # System/error messages
            "^(Caveat|Generated by|Note:|Warning:|Error:|Info:|Debug:|Invalid|Please run|Failed)",
